...
const reactNativeMakePath = resolve('.', 'node_modules', '@evlop', 'react-native-make');

if (existsSync(reactNativeMakePath)) {
  const res = lstatSync(resolve('.', 'node_modules', '@evlop', 'react-native-make'));
